...
# Ensure PATH includes standard locations #new
...
# coreutils: includes tee
# procps, moreutils: extra utils often required in runtime
...
# Ensure tee is available in /bin for scripts #new
RUN ln -s /usr/bin/tee /bin/tee || true #new
